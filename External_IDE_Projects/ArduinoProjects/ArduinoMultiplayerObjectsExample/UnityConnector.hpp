...
// database that binds channel names and variables
...
// pointer to function that handles new values received for a channel. stays constant; this is from a more complicated system
...
// check for any new messages from unity and send all variables to unity
void SERIALU_ProcessMessages() {
