...
* For instructions how to run this, please see "Deployment Instructions For All Scenes" section below.
...
### **Before you start: Setting up the Hardware and the project configuration**

* If you don't have Arduino, it's ok. Just edit the "--CYBS-- / ConfigurationProfile" gameobject by disabling "Arduino_Enabled", and skip these instructions.
* If you do have Arduino, edit the "--CYBS-- / ConfigurationProfile" gameobject to ensure "Arduino_Enabled" is active and change the COM port to the usb port the Arduino is connected. Then do the following:
...
2. Upload the example sketch through the Arduino IDE.
   ...
   * The sketch for this example scene is **ArduinoMultiplayerScene** found in **External_IDE_Projects\ArduinoProjects**
