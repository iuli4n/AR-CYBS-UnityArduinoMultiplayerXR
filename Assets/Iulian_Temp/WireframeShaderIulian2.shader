...
///
Shader "Mixed Reality Toolkit/WireframeIulian2"
{
    Properties
    {
        ...
        _WireColor("s Wire color", Color) = (1.0, 1.0, 1.0, 1.0)
        _WireThickness("Wire thickness", Range(0, 800)) = 100

        // not showing grr
        //_MaxX("Max X", Range(0, 1)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2g vert(appdata_base v)
            {
                ...
                o.mask = o.mask || v.vertex.x < minX || v.vertex.x > maxX;
                o.mask = o.mask || v.vertex.y < minY || v.vertex.y > maxY;
                o.mask = o.mask || v.vertex.z < minZ || v.vertex.z > maxZ;
                
                // remove if want to see everything
                o.mask = false;
            ...
            void geom(triangle v2g i[3], inout TriangleStream<g2f> triStream)
            {
                ...
                float cut = 0;
                if (i[0].mask || i[1].mask || i[2].mask) return;
