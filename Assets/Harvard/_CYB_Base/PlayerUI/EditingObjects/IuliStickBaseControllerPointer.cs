...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    public abstract class IuliStickBaseControllerPointer : ControllerPoseSynchronizer, IMixedRealityPointer
    {
        [SerializeField]
        ...
        // This is triggered by TEMP_Debug_Pointers when an external device clicks a special pointer
        // [TODO: There is probably a better way doing this with the MRTK input system]
        public void HACKEDOnInputUp()
        {
            if (!IsInteractionEnabled) { return; }
