...
namespace Microsoft.MixedReality.Toolkit.UI
{
    ...
    public class ObjectManipulatorIuli : MonoBehaviour, IMixedRealityPointerHandler, IMixedRealityFocusChangedHandler, IMixedRealitySourcePoseHandler
    {
        #region Public Enums
        ...
        public void OnPointerDown(MixedRealityPointerEventData eventData)
        {
            ...
            if (!EditingManager.Instance.CanMoveThis(this.gameObject))
                return;
        ...
        {
            EditingManager.Instance.BeginEditing(this.gameObject);
        ...
        {
            EditingManager.Instance.EndEditing(this.gameObject);
