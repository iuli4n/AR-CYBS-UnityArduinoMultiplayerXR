AR CYB Project (c) 2022 Harvard University
Licensed under MIT License (see [a relative link](LICENSES.txt)
...
Please see LICENSES.TXT for licensing details.

====
OTHER LIBRARIES:

Mixed Reality Toolkit 
Licensed under MIT License (see LICENSES.txt)
Downloaded January 2021 from: https://docs.microsoft.com/en-us/windows/mixed-reality/mrtk-unity/

Photon Unity Networking
Licensed under the Unity Asset Store EULA (see LICENSE_UnityAssetStore.txt)
